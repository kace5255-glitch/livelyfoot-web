      ...
      <section className="relative min-h-[70vh] flex items-center justify-center text-center px-4">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a
              href="/TallyApp"
              className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 text-cream font-semibold px-6 py-3 rounded-full border border-cream/40 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
