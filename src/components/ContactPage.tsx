...
export default function ContactPage() {
  ...
  return (
    <div>
      ...
      {/* Info Card */}
      <div className="bg-white rounded-2xl p-8 shadow-sm border border-cream-dark/30 mb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-warm-brown-dark mb-1">{t('address_label')}</p>
              <p className="text-sm text-warm-brown-dark/70">{t('address')}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-warm-brown-dark mb-1">{t('phone_label')}</p>
              <p className="text-sm text-warm-brown-dark/70">{t('phone')}</p>
              <p className="text-sm text-warm-brown-dark/70">{t('phone2')}</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="font-semibold text-warm-brown-dark mb-1">{t('hours_label')}</p>
              <p className="text-sm text-warm-brown-dark/70">{t('hours')}</p>
            </div>
          </div>
        </div>
      ...
      {/* Map */}
      <div className="bg-forest rounded-t-2xl px-4 py-3 text-cream text-center text-sm flex items-center justify-center gap-2">
