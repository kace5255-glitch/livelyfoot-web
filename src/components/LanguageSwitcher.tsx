  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm font-medium text-spa-ink/70 hover:text-gold transition-colors"
      >
          ...
          {locales.map((l) => (
            <button
              ...
              className={`w-full text-left px-4 py-2 text-sm hover:bg-cream transition-colors ${
                l === locale ? 'text-gold font-semibold' : 'text-spa-ink/70'
              }`}
            >
              {localeNames[l]}
            </button>
